...
async def _preload(model_name:str):
    ...
    try:
        ...
        if not _model or _model_name != model_name:
                ...
                # _model = whisper.load_model(model_name)  # Commented out due to installation issues
...
async def _transcribe(model_name:str, audio_bytes_b64: str):
    ...
    # Disabled whisper functionality due to installation issues
    return "Audio transcription is currently disabled due to installation issues."
